...
const PlayerCard = ({ player, onClick }: { player: Player; onClick: () => void }) => {
  ...
  return (
    ...
    >
      ...
      {imgError ? (
        <div className="h-[200px] bg-gradient-to-br from-football-neon/20 to-football-cyan/20 flex items-center justify-center">
      ...
      <div className="p-4">
        <div className="flex justify-between items-start">
          <div>
            <h3 className="font-heading text-xl text-football-neon leading-tight">{player.name}</h3>
          ...
          <div className="text-center">
            ...
            <span className="text-[10px] font-heading tracking-widest text-football-neon/60">{player.position}</span>
          </div>
        </div>
